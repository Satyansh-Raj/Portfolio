    ...
    try {
        ...
        function startBootSequence() {
            ...
            const bootSequence = [
                ...
                { content: "Loading Linux 3.2.0-4-amd64 ...", delay: 400 },
                { content: "Loading initial ramdisk ...", delay: 600 },
                { content: "", delay: 700, clear: true },
                { content: "Loading, please wait ...", delay: 1200 },
                ...
                { content: "INIT: version 2.88 booting", delay: 400 },
                { content: '[<span class="bl">INFO</span>] Using makefile-style concurrent boot in runlevel S.', delay: 200 },
                { content: '[ <span class="gn">OK</span> ]Starting the hot plug events dispatcher: udevd.', delay: 40 },
                { content: "Synthesizing the initial hotplug events...[    2.700609] piix_smbus 0000:00:07.3: Host SMBus controller not enabled!", delay: 200 },
                ...
                { content: "Checking root file system...", delay: 500 },
                { content: "done.", delay: 40 },
                ...
                { content: "Mounting local filesystems...done.", delay: 400 },
                { content: '[ <span class="gn">OK</span> ] Setting up console font and keymap...done.', delay: 300 },
                { content: "INIT: Entering runlevel: 2", delay: 600 },
                ...
                { content: "Starting system message bus: dbus", delay: 400 },
                { content: "Starting MTA: exim4.", delay: 20 },
                { content: "", delay: 500, clear: true },
                { content: "Debian GNU/Linux 7 Details ttyl", delay: 800 },
                { content: "&nbsp;", delay: 40 },
                { content: "User login: ", typedContent: "root", delay: 1000 },
                { content: "password: ", typedContent: "LAb^^e8accO+RS!n", delay: 300 },
                { content: "Loading portfolio...", delay: 1000 },
